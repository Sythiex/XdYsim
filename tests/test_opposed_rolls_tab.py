...
def test_opposed_rolls_tab_setup_controls_use_expected_order() -> None:
    ...
    try:
        ...
        assert _field_row(controls_layout, tab.attacker_circumstance_spin) == 1
        assert _field_row(controls_layout, tab.defender_combo) == 2
        assert _field_row(controls_layout, tab.defender_circumstance_spin) == 3
